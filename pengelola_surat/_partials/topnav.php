...
<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
    ...
    <ul class="navbar-nav align-items-center ms-auto">
        ...
        <!-- Alerts Dropdown-->
        <li class="nav-item dropdown no-caret d-none d-sm-block me-sm-3 me-md-0 dropdown-notifications">
        ...
        <li class="nav-item dropdown no-caret me-3">
            <a class="btn btn-icon btn-transparent-dark" id="websitePreview" href="<?= base_url() ?>" target="_blank" title="Lihat Tampilan Depan"><i data-feather="globe"></i></a>
        </li>
        <!-- User Dropdown-->
