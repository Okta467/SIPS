  ...
  <body class="nav-fixed">
              ...
              <div class="card-body">
                <table id="datatablesSimple">
                  ...
                  <tbody>
                    ...
                    <?php
                    $no = 1;
                    $query_sekretaris_desa = mysqli_query($connection, 
                      "SELECT
                    ...
                    while ($sekretaris_desa = mysqli_fetch_assoc($query_sekretaris_desa)):
                    ?>

                      <tr>
                        <td><?= $no++ ?></td>
                        <td>
                          <?= htmlspecialchars($sekretaris_desa['nama_pegawai']); ?>
                          <?= !empty($sekretaris_desa['nip'])
                            ? "<br><small class='text-muted'>({$sekretaris_desa['nip']})</small>"
                            : "<br><small class='text-muted'>(Tidak ada NIP)</small>"; ?>
                        </td>
                        <td>
                          <div class="ellipsis toggle_tooltip" title="<?= $sekretaris_desa['nama_pangkat_golongan'] ?>">
                            <?= $sekretaris_desa['nama_pangkat_golongan'] ?>
                          </div>
                        </td>
                        <td>
                          <div class="text-center"><?= strtoupper($sekretaris_desa['tipe_pangkat_golongan']) ?></div>
                        </td>
                        <td>
                          <?= "{$sekretaris_desa['nama_pendidikan']}/{$sekretaris_desa['nama_jurusan_pendidikan']}/{$sekretaris_desa['tahun_ijazah']}" ?>
                        </td>
                        <td>
                          <div class="ellipsis toggle_tooltip" title="<?= $sekretaris_desa['nama_jabatan'] ?>">
                            <?= $sekretaris_desa['nama_jabatan'] ?>
                          </div>
                        </td>
                        <td>
                          <button class="btn btn-datatable btn-icon btn-transparent-dark me-2 toggle_modal_ubah" type="button"
                            data-id_pegawai="<?= $sekretaris_desa['id_pegawai'] ?>">
                            <i class="fa fa-pen-to-square"></i>
                          </button>
                          <button class="btn btn-datatable btn-icon btn-transparent-dark me-2 toggle_modal_detail_sekretaris_desa" type="button"
                            data-id_pegawai="<?= $sekretaris_desa['id_pegawai'] ?>"
                            data-nama_pegawai="<?= $sekretaris_desa['nama_pegawai'] ?>"
                            data-username="<?= $sekretaris_desa['username'] ?>"
                            data-hak_akses="<?= $sekretaris_desa['hak_akses'] ?>"
                            data-alamat="<?= $sekretaris_desa['alamat'] ?>"
                            data-tmp_lahir="<?= $sekretaris_desa['tmp_lahir'] ?>"
                            data-tgl_lahir="<?= $sekretaris_desa['tgl_lahir'] ?>">
          ...
          <form>
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" id="xnama_pegawai" type="text" name="xnama_pegawai" placeholder="Enter nama sekretaris_desa" disabled>
              </div>
              ...
              <div class="mb-3">
                ...
                <select name="xhak_akses" class="form-control select2" id="xhak_akses" disabled>
                  <option value="sekretaris_desa" selected>Sekretaris Desa</option>
                </select>
              </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('.toggle_modal_detail_sekretaris_desa').on('click', function() {
