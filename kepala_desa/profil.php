                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        <td><?= $no++ ?></td>
                        <td>
                          <?= htmlspecialchars($kepala_desa['nama_pegawai']); ?>
          ...
          <form>
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" id="xnama_pegawai" type="text" name="xnama_pegawai" placeholder="Enter nama kepala_desa" disabled>
              </div>
              ...
              <div class="mb-3">
                ...
                <select name="xhak_akses" class="form-control select2" id="xhak_akses" disabled>
                  <option value="kepala_desa" selected>Sekretaris Desa</option>
                </select>
              </div>
