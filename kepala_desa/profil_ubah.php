<?php
    ...
    try {
        ...
        $query_kepala_desa = "UPDATE tbl_pegawai SET
            id_jabatan = ?
            , id_pangkat_golongan = ?
            , id_pendidikan = ?
        ...
        mysqli_stmt_bind_param($stmt_kepala_desa, 'iiiisssii', $id_jabatan, $id_pangkat_golongan, $id_pendidikan, $id_jurusan, $alamat, $tmp_lahir, $tgl_lahir, $tahun_ijazah, $id_pegawai);
