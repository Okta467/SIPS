...
<!-- Favicons -->
<link href="<?= base_url('assets/landing_page/img/favicon-banyuasin.png') ?>" rel="icon">
<link href="<?= base_url('assets/landing_page/img/apple-touch-icon-banyuasin.png') ?>" rel="apple-touch-icon">
